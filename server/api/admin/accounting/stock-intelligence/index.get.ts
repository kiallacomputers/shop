...
export default defineEventHandler(async(event)=>{
  ...
  const [pr,mv,map,po]=await Promise.all([
    s.from("products").select("id,name,product_code,stock,buy_price_ex_gst,price,active,category_id").eq("active",true),
