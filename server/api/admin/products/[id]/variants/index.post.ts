...
export default defineEventHandler(async (event) => {
  ...
  const price=body?.price==null||body?.price===""?null:Number(body.price), oldPrice=body?.old_price==null||body?.old_price===""?null:Number(body.old_price), stock=Number(body?.stock);
