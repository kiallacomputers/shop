...
async function load() {
  ...
  const results = await Promise.allSettled([
    adminFetch('/api/admin/purchasing/suppliers'),
...
async function addSupplier() {
  try {
    ...
    await adminFetch('/api/admin/purchasing/suppliers', { method: 'POST', body: supplier })
...
async function saveSupplier() {
  try {
    ...
    await adminFetch(`/api/admin/purchasing/suppliers/${editSupplier.id}`, { method: 'PUT', body: { name: editSupplier.name, contact_name: editSupplier.contact_name, email: editSupplier.email, phone: editSupplier.phone, abn: editSupplier.abn, address: editSupplier.address, notes: editSupplier.notes } })
    editing.value = false
