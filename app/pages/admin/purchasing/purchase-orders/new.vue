<template>
  <main class="mx-auto max-w-[1500px] px-4 py-6 md:px-7 md:py-7">
    ...
    <div class="mt-5 flex flex-wrap justify-end gap-3"><NuxtLink to="/admin/purchasing/purchase-orders" class="secondary">Cancel</NuxtLink><button class="primary" type="button" :disabled="saving" @click="save">{{ saving ? 'Saving…' : editingId ? 'Save Changes' : 'Create Purchase Order' }}</button></div>
