  ...
  <main class="admin-content">
    ...
    <section class="admin-panel p-5">
      ...
      <div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
        ...
        <NuxtLink to="/admin/purchasing/inventory" class="metric"><small>Inventory Value</small><b>{{ money(dash.summary?.inventory_value) }}</b><span>At current buy cost</span></NuxtLink>
