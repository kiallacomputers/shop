  ...
  <main class="admin-content">
    ...
    <section class="admin-panel mt-5 p-5">
      ...
      <div class="mt-4 flex flex-wrap gap-3">
        <NuxtLink class="tool-icon" to="/admin/accounting/accounts" title="Chart of Accounts" aria-label="Chart of Accounts">
          <ToolIcon path="M4 5h16v14H4V5Zm4 4h8M8 13h3m2 0h3M8 17h3m2 0h3" />
        </NuxtLink>
        <NuxtLink class="tool-icon" to="/admin/accounting/journals" title="General Journal" aria-label="General Journal">
          <ToolIcon path="M6 3h9l3 3v15H6V3Zm3 7h6m-6 4h6m-6 4h4" />
        </NuxtLink>
        <NuxtLink class="tool-icon" to="/admin/accounting/invoices" title="Sales & Invoices" aria-label="Sales & Invoices">
          <ToolIcon path="M6 3h12v18H6V3Zm3 5h6m-6 4h6m-6 4h3" />
        </NuxtLink>
        <NuxtLink class="tool-icon" to="/admin/accounting/receivables" title="Accounts Receivable" aria-label="Accounts Receivable">
          <ToolIcon path="M4 6h16v12H4V6Zm3 4h10M8 14h4m5-2 2 2-2 2" />
        </NuxtLink>
        <NuxtLink class="tool-icon" to="/admin/accounting/purchases" title="Suppliers & Purchases" aria-label="Suppliers & Purchases">
          <ToolIcon path="M3 7h18l-2 12H5L3 7Zm4 0 2-3h6l2 3M8 12h8" />
        </NuxtLink>
        <NuxtLink class="tool-icon" to="/admin/accounting/payables" title="Accounts Payable" aria-label="Accounts Payable">
...
const ToolIcon = defineComponent({
  ...
  setup(props) {
    return () => h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", class: "h-7 w-7", "aria-hidden": "true" }, [h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", d: props.path })]);
  },
});
async function load() {
  err.value = "";
...
.tool-icon { @apply flex h-14 w-14 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700; }
</style>
