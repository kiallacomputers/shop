    ...
    <div class="mx-auto max-w-6xl px-4 py-8">
      <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p class="mt-2 text-slate-500">Manage storefront promotional banners. Recommended size: 1600 × 500 px.</p>
        </div>
        <button
          type="button"
      ...
      <section v-if="showForm" class="mb-7 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div class="grid gap-5 lg:grid-cols-2">
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <span class="text-xs text-slate-500">JPG, PNG or WebP · ideally 1600 × 500 px</span>
              </div>
          ...
          <div>
            ...
            <div class="aspect-[16/5] overflow-hidden rounded-xl border border-slate-200 bg-slate-100">
              <img v-if="form.image_url" :src="form.image_url" :alt="form.title || 'Banner preview'" class="h-full w-full object-cover" />
      ...
      <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div v-else class="divide-y divide-slate-100">
          <div v-for="ad in ads" :key="ad.id" class="grid gap-4 p-5 md:grid-cols-[220px_1fr_auto] md:items-center">
            <div class="aspect-[16/5] overflow-hidden rounded-lg border border-slate-200 bg-slate-100">
