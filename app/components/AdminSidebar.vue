<template>
  <div class="flex h-full flex-col text-slate-300">
    ...
    <nav class="admin-sidebar-nav flex-1 overflow-y-auto px-3 py-4 lg:overflow-visible">
      ...
      <NavGroup title="Store" group-key="store" :active="groupActive('store')" :open="openGroup === 'store'" @toggle="toggleGroup('store')" @mouseenter="openGroup = 'store'" @mouseleave="closeHoverGroup('store')">
      ...
      <NavGroup title="Sales" group-key="sales" :active="groupActive('sales')" :open="openGroup === 'sales'" @toggle="toggleGroup('sales')" @mouseenter="openGroup = 'sales'" @mouseleave="closeHoverGroup('sales')">
      ...
      <NavGroup title="Purchasing" group-key="purchasing" :active="groupActive('purchasing')" :open="openGroup === 'purchasing'" @toggle="toggleGroup('purchasing')" @mouseenter="openGroup = 'purchasing'" @mouseleave="closeHoverGroup('purchasing')">
        ...
        <NuxtLink to="/admin/purchasing/stock-intelligence" :class="linkClass('/admin/purchasing/stock-intelligence')" @click="$emit('navigate')"><NavIcon path="M4 19V9m6 10V5m6 14v-7m4 7H2"/>Stock Intelligence</NuxtLink>
      </NavGroup>

      <NavGroup title="Business" group-key="business" :active="groupActive('business')" :open="openGroup === 'business'" @toggle="toggleGroup('business')" @mouseenter="openGroup = 'business'" @mouseleave="closeHoverGroup('business')">
      ...
      <NavGroup title="Administration" group-key="administration" :active="groupActive('administration')" :open="openGroup === 'administration'" @toggle="toggleGroup('administration')" @mouseenter="openGroup = 'administration'" @mouseleave="closeHoverGroup('administration')">
...
const closeHoverGroup = (key: string) => {
