  ...
  <div class="flex h-full flex-col text-slate-300">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
      ...
      <NavGroup title="Orders">
        ...
        <NuxtLink v-if="isSuperAdmin" to="/admin/quotes" :class="linkClass('/admin/quotes')" @click="$emit('navigate')"><NavIcon path="M6 3h9l3 3v15H6V3Zm3 7h6m-6 4h6"/>Customer Quote Requests</NuxtLink>
      ...
      <NavGroup title="Business">
        ...
        <NuxtLink v-if="isSuperAdmin" to="/admin/accounting/receivables" :class="linkClass('/admin/accounting/receivables')" @click="$emit('navigate')"><NavIcon path="M4 6h16v12H4V6Zm3 4h10m-7 4h4"/>Accounts Receivable</NuxtLink>
        <NuxtLink v-if="isSuperAdmin" to="/admin/accounting/payables" :class="linkClass('/admin/accounting/payables')" @click="$emit('navigate')"><NavIcon path="M4 6h16v12H4V6Zm3 4h10m-7 4h4"/>Accounts Payable</NuxtLink>
