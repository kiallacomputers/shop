  ...
  <div class="flex h-full flex-col text-slate-300">
    ...
    <nav class="admin-sidebar-nav flex-1 overflow-y-auto px-3 py-4">
      ...
      <NavGroup title="Purchasing" group-key="purchasing" :active="groupActive('purchasing')" :open="openGroup === 'purchasing'" @toggle="toggleGroup('purchasing')">
        <NuxtLink to="/admin/purchasing/suppliers" :class="linkClass('/admin/purchasing/suppliers')" @click="$emit('navigate')"><NavIcon path="M4 4h16v16H4V4Zm4 4h8M8 12h8M8 16h5"/>Suppliers</NuxtLink>
        ...
        <NuxtLink to="/admin/purchasing/receive-stock" :class="linkClass('/admin/purchasing/receive-stock')" @click="$emit('navigate')"><NavIcon path="M12 3v12m0 0-4-4m4 4 4-4M5 20h14"/>Receive Stock</NuxtLink>
        <NuxtLink to="/admin/purchasing/supplier-bills" :class="linkClass('/admin/purchasing/supplier-bills')" @click="$emit('navigate')"><NavIcon path="M6 3h9l3 3v15H6V3Zm3 7h6m-6 4h6"/>Supplier Bills</NuxtLink>
