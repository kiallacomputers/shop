...
const items=[
 {to:'/admin/accounting/suppliers',icon:'🚚',label:'Suppliers',caption:'Directory & products'},
 {to:'/admin/accounting/purchases',icon:'📋',label:'Purchase Orders',caption:'Create & order'},
 {to:'/admin/accounting/receive-stock',icon:'📦',label:'Receive Stock',caption:'Partial or full'},
 {to:'/admin/accounting/supplier-bills',icon:'🧾',label:'Supplier Bills',caption:'Bills & due dates'},
 {to:'/admin/accounting/payables',icon:'💳',label:'Payables',caption:'Money owing'},
 {to:'/admin/accounting/inventory',icon:'📊',label:'Inventory',caption:'Value & COGS'}
]
